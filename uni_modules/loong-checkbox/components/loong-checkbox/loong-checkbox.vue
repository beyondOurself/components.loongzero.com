...
<style lang="scss">
$loong-checkbox-diameter: 46rpx !default;
$loong-checkbox-color: #fff !default;
...
.loong-checkbox {
	...
	.checkbox_item_main {
		...
		border: solid $loong-checkbox-border $loong-checkbox-border-color;
		overflow: hidden;
		&.is--actived {
	...
	.checkbox_item_hook {
		...
		height: 55%;
		border-color: none;
		border-bottom: 4rpx solid $loong-checkbox-color;
		border-right: 4rpx solid $loong-checkbox-color;
